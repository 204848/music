...
Player.prototype = {
    ...
    seek: function (per) {
        ...
        if (sound) {
            ...
            if (!isNaN(durationVal) && durationVal > 0) {
                ...
                if (progressCurrent) progressCurrent.style.width = (per * 100) + '%';
                if (progressScrubber) progressScrubber.style.left = (per * 100) + '%';
    ...
    step: function () {
        ...
        if (progressCurrent) progressCurrent.style.width = (progressPercent * 100) + '%';
        if (progressScrubber) progressScrubber.style.left = (progressPercent * 100) + '%';
...
console.log("\n %c Gmemp v3.7.1 (Full Progress Bar JS) %c https://github.com/Meekdai/Gmemp \n", "color: #fff; background-image: linear-gradient(90deg, rgb(47, 172, 178) 0%, rgb(45, 190, 96) 100%); padding:5px 1px;", "background-image: linear-gradient(90deg, rgb(45, 190, 96) 0%, rgb(255, 255, 255) 100%); padding:5px 0;");
